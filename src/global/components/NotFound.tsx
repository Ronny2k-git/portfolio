...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-gray-400 bg-black/20 px-4">
      <h1 className="text-[6rem] font-bold text-gray-300 mb-4 animate-pulse">
        404
      </h1>

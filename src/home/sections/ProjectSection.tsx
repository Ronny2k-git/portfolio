          ...
          <Card className="w-full h-full rounded-4xl p-4 sm:p-8">
            <div className="flex flex-col h-full gap-6">
              ...
              <p className="text-gray-400">
                <span className="text-blue-200">Personal</span> projects created
                to explore <span className="text-blue-200">new</span>{' '}
                technologies and ideas, primarily for{' '}
                <span className="text-blue-200">study</span> purposes. With a
                focus on <span className="text-blue-200">database</span>{' '}
              ...
              <div className="text-gray-400">
                ...
                <span className="text-blue-200">tools</span> I used to build
                these projects:
              </div>
